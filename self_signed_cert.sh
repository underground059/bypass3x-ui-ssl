...
echo "1) Зайдите в панель управления по сгенерированным данным"
echo "2) Перейдите в Настройки панели"
echo "3) Путь к файлу ПУБЛИЧНОГО ключа сертификата: $CERT_PATH"
echo "4) Путь к файлу ПРИВАТНОГО ключа сертификата: $KEY_PATH"
echo "5) Сохраните настройки и перезагрузите панель"
echo "============================================================"
